...
public class EmailUtil {
    private static String fromEmail = "Starsay@limit.cool";  // 发件人账号
    private static String fromEmailPw = "Aa308637721";  // 发件人密码
    private static String myEmailSMTPHost = "smtp.exmail.qq.com";  // 发件邮箱服务器
